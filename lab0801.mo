...
parameter Real p1 = 6.7; //себестоимость продукта у фирмы 1
parameter Real tau2 = 17; //длительность производственного цикла фирмы 2
parameter Real p2 = 11.7; //себестоимость продукта у фирмы 2
...
//второй случай
der(M1)=M1-(b/c1)*M1*M2-(a1/c1)*M1*M1;
der(M2)=(c2/c1)*M2-(b/c1+0.00063)*M1*M2-(a2/c1)*M2*M2;
end lab0801;
